...
plt.errorbar(x1[0], y1[0], xerr=x1_err[0], yerr=y1_err[0], label="no benchmark", capsize=2)
plt.errorbar(x1[1], y1[1], xerr=x1_err[1], yerr=y1_err[1], label="ibench-cpu", capsize=2)
plt.errorbar(x1[2], y1[2], xerr=x1_err[2], yerr=y1_err[2], label="ibench-l1d", capsize=2)
plt.errorbar(x1[3], y1[3], xerr=x1_err[3], yerr=y1_err[3], label="ibench-l1i", capsize=2)
plt.errorbar(x1[4], y1[4], xerr=x1_err[4], yerr=y1_err[4], label="ibench-l2", capsize=2)
plt.errorbar(x1[5], y1[5], xerr=x1_err[5], yerr=y1_err[5], label="ibench-llc", capsize=2)
...
plt.xlim(0, 80000)
plt.xticks([0, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000], ['0', '10K', '20K', '30K', '40K', '50K', '60K', '70K', '80K'])
plt.ylim(0, 10)
